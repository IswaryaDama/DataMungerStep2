...
public class QueryParser {
	...
	public QueryParameter parseQuery(String queryString) {
		...
		queryParameter.setGetAggregateFunction(getAggregateFunctions(queryString));
		queryParameter.setGetConditions(getConditions(queryString));
		queryParameter.setGetField(getFields(queryString));
		queryParameter.setGetGroupBy(getGroupByFields(queryString));
		queryParameter.setGetLogical(getLogicalOperators(queryString));
		queryParameter.setGetOrderBy(getOrderByFields(queryString));
